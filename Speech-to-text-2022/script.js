...
actionSpeech = (speechText) => {
  ...
  switch(speechText){ 
    ...
    case "photo": // let op, "fall-through"
      image1.src = "./img/spot.jpg";
      image1.style.width = "400px";
      image1.classList.remove("hide") // show image
      break;
    case "nabil":
      window.open("https://www.hof88.nl/theater/monopoly-nabil-aoulad-ayad/");
      break;
    case "help me":
      alert("Valid speech commands: black,  reset, next page");
      break;
    case "neural":
      window.open("http://33580.hosts1.ma-cloud.nl/web/neural/")
    case "github":
      window.open("https://github.com/nNab1l")
    default:
